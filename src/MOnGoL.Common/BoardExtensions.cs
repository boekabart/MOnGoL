namespace MOnGoL.Common
{
    public static class BoardExtensions
    {
        ...
        public static Token? TokenAt(this Board aBoard, Coordinate coordinate) => aBoard.Tokens[coordinate.X, coordinate.Y];
        public static Board WithChanges(this Board aBoard, ChangeSet changes)
        {
            ...
            foreach (var change in changes.Changes)
                newBoard.Tokens[change.Coordinate.X, change.Coordinate.Y] = change.Token;
            return newBoard;
        }
    }
}
